...
$('#first').click(function() {
    if (first) {
        $('#first_info').height(0);
        $('#first').height(70);
        $('#first_img').attr('src', 'icon - plus.png');
        first = 0;
    } else {
        $('#first_info').height(70);
        $('#first').height(150);
        $('#first_img').attr('src', 'icon - minus.png');
        first = 1;
    }
});
...
$('#second').click(function() {
    if (second) {
        ...
        $('#second').height(70);
        $('#second_img').attr('src', 'icon - plus.png');
        second = 0;
    } else {
        $('#second_info').height(70);
        $('#second').height(150);
        $('#second_img').attr('src', 'icon - minus.png');
        second = 1;
    }
});
...
$('#third').click(function() {
    if (third) {
        $('#third_info').height(0);
        $('#third').height(70);
        $('#third_img').attr('src', 'icon - plus.png');
        third = 0;
    } else {
        $('#third_info').height(70);
        $('#third').height(150);
        $('#third_img').attr('src', 'icon - minus.png');
        third = 1;
    }
});
...
$('#fourth').click(function() {
    if (fourth) {
        ...
        $('#fourth').height(70);
        $('#fourth_img').attr('src', 'icon - plus.png');
        fourth = 0;
    } else {
        $('#fourth_info').height(70);
        $('#fourth').height(150);
        $('#fourth_img').attr('src', 'icon - minus.png');
        fourth = 1;
    }
});
...
$('#fifth').click(function() {
    if (fifth) {
        $('#fifth_info').height(0);
        $('#fifth').height(70);
        $('#fifth_img').attr('src', 'icon - plus.png');
        fifth = 0;
    } else {
        $('#fifth_info').height(70);
        $('#fifth').height(150);
        $('#fifth_img').attr('src', 'icon - minus.png');
        fifth = 1;
    }
});
...
$('#sixth').click(function() {
    if (sixth) {
        $('#sixth_info').height(0);
        $('#sixth').height(70);
        $('#sixth_img').attr('src', 'icon - plus.png');
        sixth = 0;
    } else {
        $('#sixth_info').height(70);
        $('#sixth').height(150);
        $('#sixth_img').attr('src', 'icon - minus.png');
        sixth = 1;
    }
});
